...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var result = (from e in emps
            where 
                (from d in depts where d.Loc == "CHICAGO" select d.DeptNo).Contains(e.DeptNo)
            select e).ToList();
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = depts.Join(emps, d => d.DeptNo, e => e.DeptNo, (d, e) => new {DName = d.DName, EName = e.EName});
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = (from e in emps 
                join g in grades on true equals true // this looks SOOOO CURSED OMFG WHYYYYYYYYYY (I couldn't find a better way)
